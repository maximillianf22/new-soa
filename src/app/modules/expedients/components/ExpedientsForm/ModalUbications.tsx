                      ...
                      <div className='row mb-1'>
                        <h3 className='card-title align-items-start flex-column'>
                          ...
                          <span className='text-muted mt-1 fw-bold fs-7'>
                            Configura los seguidores a los que les apareceran las notificaciones
                        ...
                        <table className='table table-hover table-rounded gy-3 gs-3 table-sm'>
                          <thead className='bg-light round'>
                            <tr className='fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200 pb-5'>
                              <th className='fw-bolder fs-5 text-uppercase w-20px pb-5'>RESP.</th>
                              <th className='fw-bolder fs-5 text-uppercase w-300px pb-5'>Nombre</th>
                              ...
                              <td>
                                <div className='my-auto h-100 text-center mt-0'>
                                  <div className='form-check form-check-custom form-check-solid'>
                                    <button className='btn btn-info btn-sm'>Seleccionar</button>
                                  </div>
                                </div>
                              </td>
