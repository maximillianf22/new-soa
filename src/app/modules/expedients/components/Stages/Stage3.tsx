      ...
      <div className='card'>
        <div className='card-header border-0 pt-5'>
          <h3 className='card-title align-items-start flex-column'>
            <span className='card-label fw-bolder fs-3 mb-1'>Etapa 3 Creacion del expediente</span>
        ...
        <div className='card-body'>
                ...
                <div className='col-md-5 px-5'>
                  ...
                  <div className='row mb-4 fs-6 mt-0'>
                    ...
                    <div className='col-md-12 d-grid gap-2 text-nowrap'>
                      ...
                      <button className='btn btn-sm btn-success'>Confirmar servicio proveedor con afiliado</button>
                      <div className='row'>
                        <div className='col-6 d-grid gap-2 pe-1'>
                          <button className='btn btn-sm btn-primary'>Monitoreo del Afiliado</button>
                        </div>
                        <div className='col-6 d-grid gap-2 ps-1'>
                          <button className='btn btn-sm btn-primary'>Monitoreo del Proveedor</button>
                        </div>
                      </div>
                      <button className='btn btn-sm btn-info'>Reprogramar ultimo monitoreo</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className='row text-end mt-10'>
            ...
            <div className='col-2 d-grid gap-2'>
              <button className='btn btn-primary'>Ultimo Monitoreo</button>
            </div>
          </div>
        </div>
      </div>
