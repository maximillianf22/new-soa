    ...
    <>
      <div className='row pb-5'>
        <div className='col-md-6'>
          <div className='bg-white px-12 py-10 card'>
              ...
              <div className='col-md-2'>
                <div className='mt-7 mb-7'>
                  ...
                  <button className='btn btn-danger btn-sm btn-icon position-relative'>
                    ...
                    <span className='position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger rounded-circle w-17px p-4px border border-white border-4'>
                      18
                    </span>
                  </button>
                </div>
