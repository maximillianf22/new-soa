...
export const StepProviders = () => {
  return (
    <>
      <div className='card'>
        <div className='card-body p-10 mb-10'>
          ...
          <div className='row'>
            ...
            <div className='col-md-4 px-5 fv-row my-3'>
              <InputCustom type='date' name='fecha_inicio' label='Fecha de Inicio de Actividades' />
            </div>
            <div className='col-md-4 px-5 fv-row my-3'>
              <InputCustom type='number' name='satisfaccion' label='% Satisfacción' required />
            </div>
            <div className='col-md-4 px-5 fv-row my-3'>
              <InputCustom type='number' name='infraestructura' label='% Infraestuctura' required />
            </div>
            <div className='col-md-4 px-5 fv-row my-3'>
