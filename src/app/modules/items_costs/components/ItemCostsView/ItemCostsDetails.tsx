...
import {IItemCostsDetails} from '../../Interfaces/models'

const optionsItemCosts = [
  {value: 'id1', label: 'Semanal'},
  {value: 'id2', label: 'Mensual'},
  {value: 'id3', label: 'Anual'},
]

export const ItemCostsDetails = ({
  active,
  description,
  created_at,
  updated_at,
            ...
            >
              {(props: FormikProps<any>) => (
                <Form className='w-75 mt-10'>
                  <Field name='accounts' component={InputSelect} options={optionsItemCosts} />
                </Form>
              )}
            </Formik>
          </div>
