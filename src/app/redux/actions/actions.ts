...
export const servicesActions = {
  ...
  updateService: (payload:any) => ({type: servicesTypes.Update, payload: {service:payload}}),
  createService: (payload:any) => ({type: servicesTypes.Create, payload: {service:payload}}),
}