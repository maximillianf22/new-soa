export const planServicesTypes = {
    AsyncLoad: '[planServicesRedux] start loading data',
    Load: '[planServicesRedux] load data do reducer',
    Clear: '[planServicesRedux] clear reducer data',
    Delete: '[planServicesRedux] delete planService',
    Update: '[planServicesRedux] update planService',
